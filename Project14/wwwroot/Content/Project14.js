...
{
 "use strict";
 var Project14,Client,WebSharper,Obj,UI,Var$1,Operators,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,Strings,Var,TemplateHole,EventTarget,WindowOrWorkerGlobalScope,JavaScript,JS,Unchecked,Project14_Templates,ConcreteVar,Snap,System,Guid,TemplateHoleModule,EventQ,Collections,Dictionary,Object,Pervasives,Client$1,Templates,Doc,Abbrev,Fresh,Node,HashSet,Seq,TemplateInitializer,VarStr,VarFloatUnchecked,VarBool,VarDateTime,VarFile,VarDomElement,View,Numeric,DictionaryUtil,Enumerator,T,SC$1,Docs,SC$2,DocElemNode,CharacterData,Error,KeyNotFoundException,Blob,Elt,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,Elt$1,Text,Attribute,Event,AttrModule,AttrProxy,AfterRender,AfterRenderQ,List,T$1,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,HashSetUtil,SC$4,SC$5,AppendList,DynamicAttrNode,SC$6,Scheduler,Easing,AsyncBody,SC$7,CT,HashSet$1,BindVar,String,CheckedInput,CancellationTokenSource,DomNodes,Char,DateUtil,OperationCanceledException,Lazy,SC$8,Queue,LazyExtensionsProxy,LazyRecord,Runtime$1,console,Math,Date;
 Project14=Global.Project14=Global.Project14||{};
 Client=Project14.Client=Project14.Client||{};
 ...
 Project14_Templates=Global.Project14_Templates=Global.Project14_Templates||{};
 ...
 Client.Main=function()
 {
  ...
  Var$1.Create$1(true);
  Var$1.Create$1(true);
  _=(b=(t=new ProviderBuilder.New$1(),(t.h.push(Handler.EventQ2(t.k,"click",function()
  {
   return t.i;
  },function(e)
  {
   ...
   email=TemplateHole.Value(e.Vars.Hole("email")).Get();
   if(Strings.length(TemplateHole.Value(e.Vars.Hole("password")).Get())!==0&&Strings.length(TemplateHole.Value(e.Vars.Hole("email")).Get())!==0&&Strings.length(TemplateHole.Value(e.Vars.Hole("firstname")).Get())!==0&&Strings.length(TemplateHole.Value(e.Vars.Hole("lastname")).Get())!==0&&Client.isEmailValid(email))
    self.location.assign("https://www.linkedin.com/in/om-gawde-692073272/");
   else
    Global.alert("Please make sure all your details have been entered correctly.");
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["firstname",0,null],["lastname",0,null],["email",0,null],["password",0,null],["rememberme",2,null]]),(i=new TemplateInstance.New(p[1],Project14_Templates.main(p[0])),b.i=i,i))).get_Doc();
  Templates.LoadLocalTemplates("");
  Doc.RunById("main",_);
 };
 Client.isEmailValid=function(email)
 {
  return(new Global.RegExp("^[^@\\s]+@[^@\\s]+\\.[^@\\s]+$")).test(email);
 };
 ...
 Project14_Templates.main=function(h)
 {
 ...
 SC$6.$cctor=function()
 {
  ...
  SC$6.DateTimeSetUnchecked=function(el)
  {
   return function(i)
   {
  ...
  SC$6.DateTimeGetUnchecked=function(el)
  {
   var s$7,m,o,m$1;
   s$7=el.value;
  ...
  SC$6.DateTimeApplyUnchecked=(g$1=BindVar.DateTimeGetUnchecked(),(s$1=BindVar.DateTimeSetUnchecked(),function(v)
  {
   return BindVar.ApplyValue(g$1,s$1,v);
  }));
  SC$6.FileSetUnchecked=function()
  {
   return function()
   {
    return null;
  ...
  SC$6.FileGetUnchecked=function(el)
  {
   var files;
   files=el.files;
   return{
  ...
  SC$6.FileApplyUnchecked=(g$2=BindVar.FileGetUnchecked(),(s$2=BindVar.FileSetUnchecked(),function(v)
  {
  ...
  SC$6.IntApplyUnchecked=(g$3=BindVar.IntGetUnchecked(),(s$3=BindVar.IntSetUnchecked(),function(v)
  {
  ...
  SC$6.IntApplyChecked=(g$4=BindVar.IntGetChecked(),(s$4=BindVar.IntSetChecked(),function(v)
  {
  ...
  SC$6.FloatApplyUnchecked=(g$5=BindVar.FloatGetUnchecked(),(s$5=BindVar.FloatSetUnchecked(),function(v)
  {
  ...
  SC$6.FloatApplyChecked=(g$6=BindVar.FloatGetChecked(),(s$6=BindVar.FloatSetChecked(),function(v)
  {
 ...
 {
  SC$6.$cctor();
  return SC$6.DateTimeSetUnchecked;
 };
 BindVar.DateTimeGetUnchecked=function()
 {
  SC$6.$cctor();
  return SC$6.DateTimeGetUnchecked;
 };
 ...
 {
  SC$6.$cctor();
  return SC$6.FileSetUnchecked;
 };
 BindVar.FileGetUnchecked=function()
 {
  SC$6.$cctor();
  return SC$6.FileGetUnchecked;
 };
 ...
 {
  SC$6.$cctor();
  return SC$6.DateTimeApplyUnchecked;
 };
 BindVar.FileApplyUnchecked=function()
 {
  SC$6.$cctor();
  return SC$6.FileApplyUnchecked;
 };
